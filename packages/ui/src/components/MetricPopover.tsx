        ...
        <Popover.Dropdown>
          <Card style={{ padding: "1rem", minWidth: 500 }}>
            <Group justify="space-between" mb="md">
              <Text fw={500} size="sm">Metrics for PID {pid}</Text>
            ...
            {loading ? (
              <Text c="dimmed" size="sm">Loading metrics...</Text>
            ) : data.length === 0 ? (
              <Text c="dimmed" size="sm">No metrics data available yet</Text>
            ) : (() => {
              ...
              <>
                ...
                <LineChart
                  ...
                  series={[
                    { name: "cpu_percent", color: "#82ca9d" },
                  ]}
                />

                {/* Memory */}
                <Text size="xs" fw={500} mt="lg">Memory (RSS)</Text>
                <LineChart
                  h={120}
                  w={"100%"}
                  data={memRows}
